...
<div class="contform">
        ...
        <div class="f1">
            ...
            <div class="f1">
                <div class="c1">
                    ...
                    <input type="text" required name="existencias">
                </div>
                <div class="c1">
    ...
    <?php
        ...
        if (isset($_POST['insertar'])){
            $ins="UPDATE producto SET nombre = '$nombre', descripcion = '$descripcion', existencias = '$existencias', precio = '$precio' WHERE producto.ID = '$ID'";
